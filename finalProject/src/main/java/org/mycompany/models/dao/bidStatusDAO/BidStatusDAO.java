...
@Component
@Scope("prototype")
public class BidStatusDAO implements DAO{

    private SessionFactory sessionFactory;
    private static Logger logger = Logger.getLogger(BidStatusDAO.class);
    ...
    @Autowired
    public BidStatusDAO(SessionFactory sessionFactory) {
