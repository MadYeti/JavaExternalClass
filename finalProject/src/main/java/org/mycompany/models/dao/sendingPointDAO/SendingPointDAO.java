...
@Component
@Scope("prototype")
public class SendingPointDAO implements DAO{

    private SessionFactory sessionFactory;
    private static Logger logger = Logger.getLogger(SendingPointDAO.class);
    ...
    @Autowired
    public SendingPointDAO(SessionFactory sessionFactory) {
